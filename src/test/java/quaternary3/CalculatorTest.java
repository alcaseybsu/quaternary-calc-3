...
public class CalculatorTest {
    ...
    public void testSubtractBase4() {
        assertEquals( "20", Calculator.calculate( 23 ,  "-",  3 ));
    ...
    public void testDivideBase4() {
        assertEquals( "1333" , Calculator.calculate( 3332,  "/",  2 ));
        assertEquals( "10" , Calculator.calculate( 20, "/",  2 ));
        assertEquals( "Cannot divide by zero", Calculator.calculate( 3,  "/" ,  0 ));
    ...
    public void testSquareBase4() {
        ...
        assertEquals( "1101", Calculator.calculate( 9, "square"));
    }

    @Test
    public void testSquareRootBase4() {
        assertEquals( "2", Calculator.calculate( 4, "root"));
        assertEquals( "3", Calculator.calculate( 9, "root"));
    }
}